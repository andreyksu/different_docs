...
.MACRO LDIL
	PUSH	R17					; так как в младшие регистры, нельзя впихивать данные напрямую
	LDI	R17,@1					; используются старшие регистры, а с них уже в младшие регистры
	MOV	@0,R17					; 
	POP 	R17					; 
.ENDM							; LDIL	R0,18
